...
// ============================================================
// 5.5. 🚨 CRITICAL: Map Roles to Permissions (RolePermission Table)
// ============================================================
...
const rolePermissions = [
  ...
  // 2. RECEPTIONIST: Can manage bookings, payments, view rooms, and update room status
  { roleId: getRoleId('Receptionist'), permissionId: getPermId('CanCreateReservation') },
...
console.log(`✅ Role-Permission mappings created (${rolePermissions.length})`);
