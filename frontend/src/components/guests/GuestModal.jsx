...
export default function GuestModal({ isOpen, onClose, onSubmit, isLoading, initialData }) {
        ...
        <div className="flex items-center justify-between p-6 border-b border-border">
          <div>
            ...
            <p className="text-sm text-text-muted mt-1">
              {initialData ? 'Update guest information and contact details.' : 'Register a new guest to the system.'}
            </p>
          </div>
